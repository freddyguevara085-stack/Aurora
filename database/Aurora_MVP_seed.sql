...
-- Los registros base no tienen validación clínica independiente; mantenerlos como borradores.
UPDATE contenidos_prenatales SET publicado = 0 WHERE creado_por_usuario_id IS NULL;
UPDATE senales_alerta SET activo = 0 WHERE creado_por_usuario_id IS NULL;
...
SELECT NULL, NULL,
       ...
       'La atención prenatal ayuda a acompañar el embarazo con el equipo de salud. Puedes anotar preguntas, compartir cambios que te preocupen y asistir a los controles indicados. Esta información es educativa y no sustituye la orientación profesional.',
        ...
        'OPS/OMS - Salud materna', 'https://www.paho.org/es/temas/salud-materna', '2026-08-27', 0
